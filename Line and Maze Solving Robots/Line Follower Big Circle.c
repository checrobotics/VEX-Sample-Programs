...
#pragma config(Sensor, dgtl1,  OnOffButton,         sensorTouch)
...
int nMaxSpeed = 110; //105
int nPFactor =  10; //10
int nIFactor =   0;
int nDFactor =  150; //120
...
int getLineErrorPosition()
{
  ...
  int nPos = 0;
  int nNumbOfHits = 0;
  const int kThreshold1 =  75;
  const int kThreshold2 = 250;
  const int kThreshold3 = 400;
